...
// var forestjs = (function(){
  ...
  RandomForest.prototype = {
    ...
    */
    predictOne: function(inst) {
      ...
      var dec=0;
      for(var i=0;i<this.numTrees;i++) {
        // console.log('single prediction: ', this.trees[i].predictOne(inst));
  ...
  DecisionTree.prototype = {
    ...
    predictOne: function(inst) {
        ...
        return (this.leafPositives[n] === 0 && this.leafNegatives[n] === 0) ? 0.5 : this.leafPositives[n] / (this.leafPositives[n] + this.leafNegatives[n]);
    }
  }
